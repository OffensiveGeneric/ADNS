...
- Run pipelines directly, e.g., `python src/ModelDemo/ModelDemo/meta/meta_train.py --raw_train data/UNSW_NB15_training-set.csv --out_dir outputs/meta`.
